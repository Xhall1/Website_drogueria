      ...
      <div className="py-4">
        <div className="container flex justify-between items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            font-semibold tracking-widest text-xl uppercase sm:text-20rem"
              ...
              <ul className="flex items-center gap-4">
                {
                  ...
                  <li className="relative cursor-pointer group">
                    <a 
                    href="#" className="flex items-center gap-[2px] font-semibold text-gray-500 dark:hover:text-white py-2">
                      Quick Links
                      <span>
          ...
          <div className="flex justify-between items-center gap-4">
            ...
            <div className="relative group hidden sm:block">
              ...
              <IoMdSearch
              className="text-xl text-gray-600 group-hover:text-primary dark:txt-gray-400 absolute top-1/2 -translate-y-1/2 right-3 duration-200"
              />
            </div>
