        ...
        <div className="container">
            <div style={{ backgroundColor: data.bgColor}} className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
                ...
                <div className="p-6 sm:p-8">
                    ...
                    <h1 data-aos="zoom-out" className="uppercase text-3xl lg:text-7xl font-bold"> {" "} {data.title}</h1>
                ...
                <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                    ...
                    <p data-aos="fade-up" className="text-sm trcaking-wide leading-5">{data.title4}</p>
